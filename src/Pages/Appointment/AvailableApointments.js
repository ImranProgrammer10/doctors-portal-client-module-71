...
const AvailableApointments = ({date}) => {
    ...
    const { data: services, isLoading, refetch } = useQuery(['available', formattedDate], () => fetch(`https://doctors-portal-server-module-72.vercel.app/available?date=${formattedDate}`)
        .then(res => res.json()))
